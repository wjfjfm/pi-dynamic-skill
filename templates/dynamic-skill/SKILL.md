...
Discover unaccessed children through each root's index; they are not injected
as an extra skill list. Only roots are exempt from LRU. All descendants,
including direct children, enter the LRU queue after successful read, write,
or edit and follow the same capacity and eviction rules.
